...
**State File**: [remnux.python-packages.xortool](https://github.com/REMnux/salt-states/blob/master/./remnux/python-packages/xortool.sls)
...
**Notes**: malconf  
**State File**: [remnux.python-packages.ratdecoders](https://github.com/REMnux/salt-states/blob/master/./remnux/python-packages/ratdecoders.sls)
...
**State File**: [remnux.python-packages.unxor](https://github.com/REMnux/salt-states/blob/master/./remnux/python-packages/unxor.sls)
...
**Notes**: mwcp  
**State File**: [remnux.python-packages.dc3-mwcp](https://github.com/REMnux/salt-states/blob/master/./remnux/python-packages/dc3-mwcp.sls)
...
**State File**: [remnux.python-packages.unicode](https://github.com/REMnux/salt-states/blob/master/./remnux/python-packages/unicode.sls)
...
**License**: Free, unknown license  
**State File**: [remnux.scripts.ex\_pe\_xor](https://github.com/REMnux/salt-states/blob/master/./remnux/scripts/ex_pe_xor.sls)
